...
search: White Scar Cave, Ingleton, UK
category: Cave
permalink: /places/white-scar-cave/
redirect_from:
  - /guide/your-local-area-guide-to-getting-about-walking-sho/white-scar-cave/
layout: base
meta_title: White Scar Cave | Caves Near Garsdale
meta_description: White Scar Cave, a cave near Garsdale and Sedbergh in the Yorkshire Dales.
google_place_id: ChIJS_af7lN6fEgRPJt1XABMznA
google:
  name: White Scar Cave
  category_name: Tourist attraction
  categories:
      - Tourist attraction
  address: White Scar Cave, Carnforth LA6 3AW, United Kingdom
  phone: +44 15242 41244
  phone_unformatted: 441524241244
  website: https://whitescarcave.co.uk/
  location:
      lat: 54.1656094
      lng: -2.4417634
  plus_code: "5H85+67 Carnforth, United Kingdom"
  rating: 4.7
  reviews_count: 3281
  opening_hours:
      - day: Monday
...
blocks:
  ...
  - type: split-image
    content: |-
      ...
      The cave stays at a steady 8°C all year round, so a jumper or jacket is a good idea whatever the weather above ground. There is a large car park beside the road and the cave entrance and visitor centre are a two-minute walk from it. The B6255 runs from Ingleton over to Hawes, so the cave pairs well with a day out in Upper Wensleydale if you are staying in Garsdale.

      - **Address:** White Scar Cave, B6255, Ingleton, North Yorkshire, LA6 3AW
      - **Phone:** 015242 41244
      - **Website:** [whitescarcave.co.uk](https://whitescarcave.co.uk/)
    figure_src: /images/guide-pages/white-scar-cave.jpeg
    figure_alt: White Scar Cave
  - type: items
    collection: properties
    intro_content: |-
          ## Stay Near White Scar Cave
          
          We have three [holiday cottages](/properties/) in Garsdale you can use as a base for visiting White Scar Cave.
  - type: markdown
    content: |-
          ## See Also
          
          - [Ingleborough Cave](/places/ingleborough-cave/) - the other great show cave of the Dales, above Clapham
