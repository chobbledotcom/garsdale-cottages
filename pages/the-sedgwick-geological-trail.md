...
meta_description: The Sedgwick Geological Trail at Danny Bridge follows the Dent Fault
  along the River Clough, named after geologist Adam Sedgwick who was born in nearby
  Dent.
blocks:
- type: image-background
  ...
  content: '# The Sedgwick Geological Trail

    '
- type: markdown
  content: 'One of the most unusual walks in the area follows the River Clough from
    Danny Bridge, tracing the dramatic Dent Fault through a landscape that tells a
    story stretching back nearly 300 million years.
...
- type: split-image
  content: '## The Walk
    ...
    on the Lake District side by as much as two and a half kilometres relative to
...
- type: split-image
  content: '## Adam Sedgwick
    ...
    name. The Geological Trail was established in 1985 to mark the bicentenary of
    his birth.
...
- type: features
  ...
  - icon: hugeicons:map-pin
    description: Danny Bridge is on the A684 about four miles east of Sedbergh. There
      is limited parking.
    name: Location
  - icon: hugeicons:eye
    description: From the viewing point at Longstone Fell, you can walk down to Danny
      Bridge to join the trail. The views over the Howgill Fells are outstanding in
      their own right.
    name: Longstone Fell
  - icon: hugeicons:alert-circle
    description: The riverbanks can be steep and slippery, particularly after rain.
      Sturdy footwear is recommended.
    name: Take Care
  intro_content: '## Getting There'
- type: cta
  button:
