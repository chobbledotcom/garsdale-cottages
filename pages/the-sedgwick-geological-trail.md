...
meta_description: The Sedgwick Geological Trail at Danny Bridge follows the Dent Fault along the River Clough, named after geologist Adam Sedgwick who was born in nearby Dent.
blocks:
  ...
  - type: features
    items:
          - icon: hugeicons:map-pin
            description: Danny Bridge is on the A684 about four miles east of Sedbergh. There is limited parking.
            name: Location
          - icon: hugeicons:eye
            description: From the viewing point at Longstone Fell, you can walk down to Danny Bridge to join the trail. The views over the Howgill Fells are outstanding in their own right.
            name: Longstone Fell
          - icon: hugeicons:alert-circle
            description: The riverbanks can be steep and slippery, particularly after rain. Sturdy footwear is recommended.
            name: Take Care
