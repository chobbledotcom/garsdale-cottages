...
blocks:
  ...
  - type: features
    ...
    items:
      - icon: hugeicons:volume-off
        title: Deep Quiet
        description:
          A valley with almost no traffic. Most guests comment on how
          startlingly quiet it is, especially at night.
  ...
  - type: cta
    ...
    description: Get in touch and we'll help you build a few days of walking,
      rest and good food in one of the quietest corners of the Dales.
    button:
      text: Contact Us
      href: /contact/
---
