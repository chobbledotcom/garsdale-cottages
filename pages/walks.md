...
blocks:
  ...
  - type: features
    ...
    items:
      ...
      - icon: hugeicons:t-shirt
        ...
        description: Good walking shoes, a stick if you use one, and layers for
          changeable weather.
  ...
  - type: markdown
    content: >
      ...
      Garsdale does not have an organisation that does guided walks but please
      talk to the cottage owners for information on the routes of those local
      walks that suit your needs.
  - type: markdown
    content: >
      ## Useful Links
