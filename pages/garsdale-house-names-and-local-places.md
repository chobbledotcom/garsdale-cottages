---
name: Garsdale House Names and Local Places
header_text: Garsdale House Names and Local Places
layout: base
permalink: /garsdale-house-names-and-local-places/
subtitle: Historic house names, farm names and local place names through the dale
meta_title: Garsdale House Names and Local Places | Yorkshire Dales
meta_description: Historic Garsdale house names, farm names and local place names, from Garsdale Foot and The Street to Garsdale Head, Hawes Junction and Grisedale.
blocks:
  - type: image-background
    parallax: true
    image: /images/old-garsdale/historical-white-cottages.png
    image_alt: Historic white cottages beside a lane in Garsdale
    content: |-
  ...
  - type: markdown
    content: |-
          ...
          The old Garsdale community website described the dale in a useful local way: the road-signed centre includes The Street, while the other main centre of population is Garsdale Head, still often known as Hawes Junction after the former Wensleydale branch of the Settle-Carlisle railway. To locals, the whole stretch from Garsdale Foot to [Mount Zion Chapel](/places/mount-zion-chapel-garsdale-head/) is simply Garsdale.
  ...
  - type: split-image
    ...
    figure_alt: Stone houses beside the road in old Garsdale
    reverse: false
  - type: split-image
    content: |-
  ...
  - type: markdown
    content: |-
          ...
          At the eastern end of the dale, the old house list changes character as the railway becomes part of the story. It records Junction Cottage, formerly the Junction Inn, along with Clough House, Clough Cottage, East Clough, Moorland View, the Railway Cottages, [Mount Zion Chapel](/places/mount-zion-chapel-garsdale-head/), Brookside, West Mudbecks, East Mudbecks, Dandrymire and Low Moor.
          
          Those names sit close to [Garsdale Station](/places/garsdale-station/), the Dandrymire Viaduct and the road over to Dent. They help explain why Garsdale Head still carries the older railway name Hawes Junction, even though the Wensleydale branch line is long gone.
  ...
  - type: markdown
    content: |-
          ...
          - [Garsdale Dialect](/garsdale-dialect/)
          - [Grisedale: The Dale That Died](/grisedale/)
