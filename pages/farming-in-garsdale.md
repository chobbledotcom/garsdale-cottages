...
- type: bunny-video-background
  ...
  content: '# Farming in Garsdale

    '
- type: markdown
  content: 'Farming is the backbone of Garsdale. The dale has been worked by farmers
    for centuries, and the landscape you see today, the patchwork of stone-walled
    fields, the barns, the open fell above, has been shaped almost entirely by their
    hands.
...
- type: split-image
  content: '## Sheep Farming
    ...
    changed less than you might expect.
...
- type: split-image
  content: '## The Farming Year
    ...
    farmers are out in all conditions tending their stock.
...
- type: markdown
  content: '## Living Alongside Farming
    ...
    knowledge of the dale and its history.
