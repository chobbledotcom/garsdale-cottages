...
- type: markdown
  content: |-
    ...
    *10 miles/17km from Clapham, or 7 miles from Ingleton | 5-7 hours | moderate to challenging*
    ...
    The most interesting route up starts from Clapham and climbs past Ingleborough Cave, through Gaping Gill - where a stream disappears underground into one of Britain's deepest potholes - and up through Trow Gill, a dramatic limestone gorge. From Ingleton the route is shorter and more direct, following a well-worn path. There are pubs, cafes and shops in Clapham for refreshments afterwards. The [Ingleborough Cave](/guide/your-local-area-guide-to-getting-about-walking-sho/ingleborough-cave/) and [White Scar Cave](/guide/your-local-area-guide-to-getting-about-walking-sho/white-scar-cave/) are both on the lower slopes if you want to pair the fell with an underground visit.

    Ingleborough is about 40 minutes' drive from Garsdale, so it makes a good day out from [Roger Pot](/properties/roger-pot/) or [The Old Cart House](/properties/the-old-cart-house/). Parking is in Clapham village (LA2 8EF) or at the National Park car park in Ingleton.

    ## Walk details

    - **Start point:** Clapham (LA2 8EF) or Ingleton
    - **Distance:** 10 miles from Clapham, 7 miles from Ingleton
    - **Parking:** National Park car park in Clapham village
    - **Route description:** [Yorkshire Dales National Park - Ingleborough](https://www.yorkshiredales.org.uk/things-to-do/get-outdoors/yorkshire-three-peaks/ingleborough-2/)

    ## Nearby on this site

    - [Ingleborough Cave](/guide/your-local-area-guide-to-getting-about-walking-sho/ingleborough-cave/) - show cave on the lower slopes, above Clapham
    - [White Scar Cave](/guide/your-local-area-guide-to-getting-about-walking-sho/white-scar-cave/) - the longest show cave in Britain, near Ingleton
